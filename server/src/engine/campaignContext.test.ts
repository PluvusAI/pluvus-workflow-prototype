...
import { mergeCampaignFallback, resolveBrandName, toCampaignBrandFields } from "./campaignContext.js";
...
// ---------------------------------------------------------------------------
// PLU-137/138 — post-PLU-135 the material terms live on CampaignDetails, NOT
