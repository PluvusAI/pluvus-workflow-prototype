...
const FALLBACK: Record<InstanceState, XY> = {
  ...
  OUTREACH_QUEUED: { x: FALLBACK_COL_MAIN, y: FALLBACK_ROW },
  OUTREACH_SENT: { x: FALLBACK_COL_MAIN, y: FALLBACK_ROW * 2 },
  AWAITING_REPLY: { x: FALLBACK_COL_MAIN, y: FALLBACK_ROW * 3 },
  FOLLOWED_UP: { x: FALLBACK_COL_BRANCH, y: FALLBACK_ROW * 3 },
  REPLY_RECEIVED: { x: FALLBACK_COL_MAIN, y: FALLBACK_ROW * 4 },
  NEGOTIATING: { x: FALLBACK_COL_MAIN, y: FALLBACK_ROW * 5 },
  ACCEPTED: { x: FALLBACK_COL_MAIN, y: FALLBACK_ROW * 6 },
  REWARD_PENDING: { x: FALLBACK_COL_MAIN, y: FALLBACK_ROW * 7 },
  REWARD_CONFIRMED: { x: FALLBACK_COL_MAIN, y: FALLBACK_ROW * 8 },
  PAYMENT_PENDING: { x: FALLBACK_COL_MAIN, y: FALLBACK_ROW * 9 },
  PAYMENT_RECEIVED: { x: FALLBACK_COL_MAIN, y: FALLBACK_ROW * 10 },
  CONTENT_BRIEF_SENT: { x: FALLBACK_COL_MAIN, y: FALLBACK_ROW * 11 },
  NEEDS_DEAL_FINALIZATION: { x: FALLBACK_COL_BRANCH, y: FALLBACK_ROW * 7 },
  HANDOFF_COMPLETE: { x: FALLBACK_COL_BRANCH, y: FALLBACK_ROW * 8 },
  AWAITING_BRAND_APPROVAL: { x: FALLBACK_COL_BRANCH, y: FALLBACK_ROW * 9 },
  REJECTED: { x: FALLBACK_COL_BRANCH, y: FALLBACK_ROW * 4 },
  MANUAL_REVIEW: { x: FALLBACK_COL_FAR, y: FALLBACK_ROW * 4.5 },
  OPTED_OUT: { x: FALLBACK_COL_BRANCH, y: FALLBACK_ROW * 6 },
  NO_RESPONSE: { x: FALLBACK_COL_FAR, y: FALLBACK_ROW * 3 },
};
