...
export const SECTIONS: SectionSpec[] = [
  ...
  // -------------------------------------------------------------------------
  // PLU-140 (2b), worksheet Page 9 + Final readiness/activation checkpoint —
  // Review + Activate. A MARKER section: it has no editable fields (fields: [])
  // and is rendered by the dedicated <LaunchReview> component, not the field
  // stepper. The public/private split, approval checkboxes, readiness blockers,
  // and the authoritative Activate live there.
  // -------------------------------------------------------------------------
  {
    key: "reviewActivate",
    title: "Review & activate", // COPY:PLU-159 (worksheet Page 9)
    blurb:
      "Verify the public Campaign Brief creators will see and the private authority that stays internal, then activate.", // COPY:PLU-159 (worksheet Page 9 purpose)
    fields: [],
  },
];
